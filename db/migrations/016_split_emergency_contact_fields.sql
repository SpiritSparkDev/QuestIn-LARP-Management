...
ALTER TABLE users RENAME COLUMN emergency_contact_enc TO emergency_contact_legacy_enc;
...
ALTER TABLE invitations RENAME COLUMN emergency_contact_enc TO emergency_contact_legacy_enc;
